...
namespace LostArkLogger
{
    public partial class PCStruct
    {
        public void SteamDecode(BitReader reader)
        {
			...
			itemInfos = reader.ReadList<ItemInfo>(0);
			b_0 = reader.ReadByte();
			b_1 = reader.ReadByte();
			...
			b_3 = reader.ReadByte();
			u32list = reader.ReadList<uint>(0);
			b_4 = reader.ReadByte();
			u16_2 = reader.ReadUInt16();
			b_5 = reader.ReadByte();
			b_6 = reader.ReadByte();
			subPKTNewNpc5 = reader.Read<subPKTNewNpc5>(0);
			u32_6 = reader.ReadUInt32();
			skillRunes = reader.Read<SkillRunes>(0);
			b_7 = reader.ReadByte();
			PlayerId = reader.ReadUInt64();
			ClassId = reader.ReadUInt16();
			Level = reader.ReadUInt16();
			EquippedItems = reader.ReadList<ItemInfo>(0);
			b_8 = reader.ReadByte();
			b_9 = reader.ReadByte();
